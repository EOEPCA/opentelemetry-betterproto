...
class Metric(betterproto.Message):
    ...
    metadata: List["__common_v1__.KeyValue"] = betterproto.message_field(12)
    """
...
class NumberDataPoint(betterproto.Message):
    ...
    attributes: List["__common_v1__.KeyValue"] = betterproto.message_field(7)
    """
    ...
    time_unix_nano: int = betterproto.fixed64_field(3)
    """
    ...
    as_int: int = betterproto.sfixed64_field(6, group="value")
...
class HistogramDataPoint(betterproto.Message):
    ...
    count: int = betterproto.fixed64_field(4)
    """
    ...
    sum: Optional[float] = betterproto.double_field(5, optional=True)
    """
    ...
    bucket_counts: List[int] = betterproto.fixed64_field(6)
    """
    ...
    min: Optional[float] = betterproto.double_field(11, optional=True)
    """min is the minimum value over (start_time, end_time]."""

    max: Optional[float] = betterproto.double_field(12, optional=True)
...
class ExponentialHistogramDataPoint(betterproto.Message):
    ...
    zero_count: int = betterproto.fixed64_field(7)
    """
    ...
    min: Optional[float] = betterproto.double_field(12, optional=True)
    """min is the minimum value over (start_time, end_time]."""

    max: Optional[float] = betterproto.double_field(13, optional=True)
    """max is the maximum value over (start_time, end_time]."""
...
class Exemplar(betterproto.Message):
    ...
    filtered_attributes: List["__common_v1__.KeyValue"] = betterproto.message_field(7)
    """
    ...
    time_unix_nano: int = betterproto.fixed64_field(2)
    """
